...
$(document).ready(function() {
		 $.get("${pageContext.request.contextPath}/rest/map", function(data, status){
		...
		out +="<td>"+data[key].email+"</td>"
		out +="<td>"+data[key].address.address1+"</td>"
		out +="<td>"+data[key].address.address2+"</td>"
		out +="<td>"+data[key].zipcode+"</td>"
